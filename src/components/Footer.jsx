...
const SOCIAL_LINKS = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/share/1L3DJezxGk/',
    icon: (
  ...
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/nextriseindiafoundation?igsh=MWljNHd5bjNvcnVlZA==',
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'X',
    href: 'https://x.com/nextriseindiafoundation',
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/nextrise-india-foundation/',
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
